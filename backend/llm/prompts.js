import { MODIFICATIONS_TAG_NAME, WORK_DIR } from "./utils.js";
import { allowedHTMLElements } from "./utils.js";
...
<system_constraints>
  ...
  IMPORTANT: No need to create a vite project it will be given in the template.
...
<artifact_info>
  ...
  <artifact_instructions>
    ...
    4. Wrap the content in opening and closing \`<zapArtifact>\` tags. These tags contain more specific \`<zapAction>\` elements.

    5. Use a \`<info>\` tag to give information about the project.
    ...
    8. Use \`<zapAction>\` tags to define specific actions to perform.

    9. For each \`<zapAction>\`, add a type to the \`type\` attribute of the opening \`<zapAction>\` tag to specify the type of the action. Assign one of the following values to the \`type\` attribute:
    ...
    11. Make the changes for the project from the given template using the \`<zapAction>\` tags. For files use type="file" and filePath attributes. If you need to install dependencies, put the install command in the \`<zapAction>\` tags with type="shell" attribute.

    IMPORTANT: DO NOT DIRECTLY MODIFY the 'package.json' file directly. If you need to install dependencies, use the \`<zapAction>\` tags with type="shell".
...
<examples>
  ...
  <example>
    ...
    <assistant_response>
    <zapArtifact id="snake-game" title="Snake Game in HTML and JavaScript">
      <info>
      ...
      <zapAction type="shell">
        ...
        <zapAction type="file" filePath="script.js">
          ...
        </zapAction>
  ...
  <example>
    ...
    <assistant_response>
      <zapArtifact id="bouncing-ball-react" title="Bouncing Ball with Gravity in React">
        <info>
